...
export class JwtEd25519Util {
     ...
     * @param sub subject
     */
    static async generateJwt(kid, sub) {
     ...
     * @param sub subject
     */
    static async generateJwtWithKeyPath(privateKeyPath, kid, sub) {
        const alg = 'EdDSA';
        // iat = 当前时间戳 - 30秒
    ...
    static async loadEd25519PrivateKey(privateKeyPath) {
        // 读取 PEM 文件内容
        const fullPath = path.resolve(__dirname, privateKeyPath);
    ...
    static signEd25519(privateKey, data) {
